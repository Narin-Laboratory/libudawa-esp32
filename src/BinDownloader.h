#ifndef BinDownloader_H_
#define BinDownloader_H_

#ifndef BinDownloader_1_1_COMPATIBLE
#define BinDownloader_1_1_COMPATIBLE
#endif
...
#define BinDownloader_DEFAULT_TCP_TIMEOUT (5000)
 ...
 * ensure the client object lives the entire time of the BinDownloader
 */
...
protected:
    ...
    String _host;
    uint16_t _port = 0;
    int32_t _connectTimeout = BinDownloader_DEFAULT_TCP_TIMEOUT;
    bool _reuse = true;
    uint16_t _tcpTimeout = BinDownloader_DEFAULT_TCP_TIMEOUT;
    ...
    String _protocol;
    String _headers;
    String _userAgent = "ESP32BinDownloader";
