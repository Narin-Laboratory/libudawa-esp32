 ...
 * This file is part of the BinDownloader for Arduino.
...
#ifdef BinDownloader_1_1_COMPATIBLE
#include <WiFi.h>
...
#endif // BinDownloader_1_1_COMPATIBLE

/**
 * constructor
 */
BinDownloader::BinDownloader()
{
}
 ...
 * @return success bool
 */
bool BinDownloader::begin(WiFiClient &client, String url) {
#ifdef BinDownloader_1_1_COMPATIBLE
    if(_tcpDeprecated) {
 ...
 * @return success bool
 */
bool BinDownloader::begin(WiFiClient &client, String host, uint16_t port, String uri, bool https)
{
#ifdef BinDownloader_1_1_COMPATIBLE
    if(_tcpDeprecated) {
        log_d("mix up of new and deprecated api");
...
#ifdef BinDownloader_1_1_COMPATIBLE
bool BinDownloader::begin(String url, const char* CAcert)
{
 ...
 * @param url String
 */
bool BinDownloader::begin(String url)
{
    if(_client && !_tcpDeprecated) {
        log_d("mix up of new and deprecated api");
        _canReuse = false;
...
bool BinDownloader::beginInternal(String url, const char* expectedProtocol)
{
...
#ifdef BinDownloader_1_1_COMPATIBLE
bool BinDownloader::begin(String host, uint16_t port, String uri)
{
    if(_client && !_tcpDeprecated) {
        log_d("mix up of new and deprecated api");
        _canReuse = false;
...
bool BinDownloader::begin(String host, uint16_t port, String uri, const char* CAcert)
{
    if(_client && !_tcpDeprecated) {
        log_d("mix up of new and deprecated api");
        _canReuse = false;
...
bool BinDownloader::begin(String host, uint16_t port, String uri, const char* CAcert, const char* cli_cert, const char* cli_key)
{
    if(_client && !_tcpDeprecated) {
        log_d("mix up of new and deprecated api");
        _canReuse = false;
 ...
 */
void BinDownloader::disconnect(bool preserveClient)
{
    if(connected()) {
 ...
 * @param reuse bool
 */
void BinDownloader::setReuse(bool reuse)
{
    _reuse = reuse;
}
 ...
 */
void BinDownloader::setUserAgent(const String& userAgent)
{
 ...
 */
void BinDownloader::setAuthorization(const char * user, const char * password)
{
    if(user && password) {
        String auth = user;
        auth += ":";
 ...
 */
void BinDownloader::setAuthorization(const char * auth)
{
    if(auth) {
 ...
 */
void BinDownloader::setAuthorizationType(const char * authType)
{
    if(authType) {
 ...
 */
void BinDownloader::setConnectTimeout(int32_t connectTimeout)
{
 ...
 */
void BinDownloader::setTimeout(uint16_t timeout)
{
    _tcpTimeout = timeout;
    if(connected()) {
 ...
 * @param use
 */
void BinDownloader::useHTTP10(bool useHTTP10)
{
 ...
 * @return http code
 */
int BinDownloader::POST(uint8_t * payload, size_t size)
{
    return sendRequest("POST", payload, size);
}

int BinDownloader::POST(String payload)
{
 ...
 * @return http code
 */
int BinDownloader::PATCH(uint8_t * payload, size_t size)
{
    return sendRequest("PATCH", payload, size);
}

int BinDownloader::PATCH(String payload)
{
 ...
 * @return http code
 */
int BinDownloader::PUT(uint8_t * payload, size_t size) {
    return sendRequest("PUT", payload, size);
}

int BinDownloader::PUT(String payload) {
 ...
 * @return
 */
int BinDownloader::sendRequest(const char * type, String payload)
{
 ...
 */
int BinDownloader::sendRequest(const char * type, uint8_t * payload, size_t size)
{
    int code;
    bool redirect = false;
 ...
 * @return -1 if no info or > 0 when Content-Length is set by server
 */
int BinDownloader::sendRequest(const char * type, Stream * stream, size_t size)
{
 ...
 * @return -1 if no info or > 0 when Content-Length is set by server
 */
int BinDownloader::getSize(void)
{
    return _size;
}
 ...
 * @return WiFiClient
 */
WiFiClient& BinDownloader::getStream(void)
{
    if (connected()) {
        return *_client;
    }
 ...
 * @return WiFiClient*
 */
WiFiClient* BinDownloader::getStreamPtr(void)
{
    if(connected()) {
        return _client;
    }
 ...
 */
int BinDownloader::writeToStream(Stream * stream)
{
 ...
 * @return String
 */
String BinDownloader::getString(void)
{
 ...
 * @return String
 */
String BinDownloader::errorToString(int error)
{
    switch(error) {
 ...
 * @param first
 */
void BinDownloader::addHeader(const String& name, const String& value, bool first, bool replace)
{
...
void BinDownloader::collectHeaders(const char* headerKeys[], const size_t headerKeysCount)
{
...
String BinDownloader::header(const char* name)
{
    for(size_t i = 0; i < _headerKeysCount; ++i) {
...
String BinDownloader::header(size_t i)
{
...
String BinDownloader::headerName(size_t i)
{
    if(i < _headerKeysCount) {
...
int BinDownloader::headers()
{
    return _headerKeysCount;
}

bool BinDownloader::hasHeader(const char* name)
{
    for(size_t i = 0; i < _headerKeysCount; ++i) {
 ...
 */
bool BinDownloader::connect(void)
{
    if(connected()) {
        if(_reuse) {
    ...
    if (!_client) {
        log_d("BinDownloader::begin was not called or returned error");
        return false;
    }
#ifdef BinDownloader_1_1_COMPATIBLE
 ...
 * @return status
 */
bool BinDownloader::sendHeader(const char * type)
{
    if(!connected()) {
        return false;
    }
 ...
 */
int BinDownloader::handleHeaderResponse()
{
 ...
 */
int BinDownloader::writeToStreamDataBlock(Stream * stream, int size)
{
 ...
 * @return error
 */
int BinDownloader::returnError(int error)
{
    if(error < 0) {
...
void BinDownloader::setFollowRedirects(followRedirects_t follow)
{
    _followRedirects = follow;
}

void BinDownloader::setRedirectLimit(uint16_t limit)
{
 ...
 * @param url
 */
bool BinDownloader::setURL(const String& url)
{
...
const String &BinDownloader::getLocation(void)
{
    return _location;
}

void BinDownloader::setCookieJar(CookieJar* cookieJar)
{
    _cookieJar = cookieJar;
}

void BinDownloader::resetCookieJar()
{
    _cookieJar = nullptr;
}

void BinDownloader::clearAllCookies()
{
    if (_cookieJar) _cookieJar->clear();
}

void BinDownloader::setCookie(String date, String headerValue)
{
    if (!_cookieJar)
    {
        return;
...
bool BinDownloader::generateCookieString(String *cookieString)
{
    time_t now_local = time(NULL);
    time_t now_gmt = mktime(gmtime(&now_local));
